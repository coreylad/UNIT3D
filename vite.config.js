  ...
  plugins: [
    laravel({
      input: [
        ...
        'resources/sass/themes/_betaups.scss',
        'resources/sass/themes/_command-center.scss',
        'resources/sass/themes/_command-center-mobile.scss',
        'resources/sass/themes/_classic.scss',
        'resources/js/app.js',
